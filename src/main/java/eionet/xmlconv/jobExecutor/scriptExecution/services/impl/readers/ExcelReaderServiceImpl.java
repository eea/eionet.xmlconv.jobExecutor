...
public class ExcelReaderServiceImpl implements SourceReaderService {
     ...
     */
    public ExcelReaderServiceImpl(boolean excel2007) {
        isExcel2007 = excel2007;
    }

    @Override
    public void initReader(File inputFile) throws ConversionException {
        if (inputFile == null) {
        ...
        try {
            ...
            throw new ConversionException("ErrorConversionHandler - couldn't open Excel file: " + e.toString());
        }
    ...
    public void startReader(ConversionResultDto resultObject) {
        readerLogger = new SourceReaderLoggerServiceImpl(resultObject, SourceReaderLoggerServiceImpl.ReaderTypeEnum.EXCEL);
    ...
    private Sheet getMetaSheet(String mainSheetName) {
        return getSheet(mainSheetName + DDXMLConverterServiceImpl.META_SHEET_NAME);
    }
    ...
    private void logColumnMappings(String sheetName, Row row, Row metaRow, List<DDXmlElement> elements) {
        ...
        if (metaRow != null) {
            ...
            readerLogger.logNumberOfColumns(nofMetaColumns, sheetName + DDXMLConverterServiceImpl.META_SHEET_NAME);
        }
