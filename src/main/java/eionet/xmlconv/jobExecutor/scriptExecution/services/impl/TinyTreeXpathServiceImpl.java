...
@Service
public class TinyTreeXpathServiceImpl implements XPathQueryService {

    private XdmNode root = null;
    private XPathCompiler compiler;

    @Autowired
    public TinyTreeXpathServiceImpl(){
     ...
     */
    public TinyTreeXpathServiceImpl(Processor processor, XdmNode root) {
        this.root = root;
