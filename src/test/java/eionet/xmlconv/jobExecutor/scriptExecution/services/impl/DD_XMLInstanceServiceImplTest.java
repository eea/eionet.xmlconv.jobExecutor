...
public class DD_XMLInstanceServiceImplTest {
    ...
    public void testGetInvalidSchemaMessage() throws Exception {
        MockDDXMLConverterService ddConverter = new MockDDXMLConverterService(new Excel2XMLServiceImpl(), null);
        ...
        MockDDXMLConverterService ddExcelConverter = new MockDDXMLConverterService(new Excel2XMLServiceImpl(), null);
        ...
        assertEquals(
                (Properties.getMessage(Constants.ERROR_CONVERSION_OBSOLETE_TEMPLATE,
    ...
    public void testConvertDDExcelToXml_MultipleValues() throws Exception {
        ...
        MockDDXMLConverterService converter = new MockDDXMLConverterService(new Excel2XMLServiceImpl(), new File(this.getClass().getClassLoader().getResource(TestConstants.SEED_MULTIVALUES_XLS)
                .getFile()));
        Map<String, String> dataset = new HashMap<String, String>();
        dataset.put("id", "6585");
        dataset.put("status", "Released");
    ...
    public void testConvertDDExcel2007ToXml_MultipleValues() throws Exception {
        ...
        MockDDXMLConverterService converter = new MockDDXMLConverterService(new Excel20072XMLServiceImpl(), new File(this.getClass().getClassLoader().getResource(TestConstants.SEED_MULTIVALUES_XLSX)
                .getFile()));
        Map<String, String> dataset = new HashMap<String, String>();
        dataset.put("id", "6585");
        dataset.put("status", "Released");
    ...
    public void testConvertDDOdsToXml_MultipleValues() throws Exception {
        File inFile = new File(this.getClass().getClassLoader().getResource(TestConstants.SEED_MULTIVALUES_ODS)
                .getFile());
        MockDDXMLConverterService converter = new MockDDXMLConverterService(new Ods2XmlServiceImpl(), inFile);
        Map<String, String> dataset = new HashMap<String, String>();
        dataset.put("id", "6585");
        dataset.put("status", "Released");
        dataset.put("isLatestReleased", "true");
    ...
    public void testConvertDDExcelToXml_Warning() throws Exception {
        ...
        MockDDXMLConverterService converter = new MockDDXMLConverterService(new Excel2XMLServiceImpl(), new File(this.getClass().getClassLoader().getResource(TestConstants.SEED_VALIDATION_WARNINGS_XLS)
                .getFile()));
        Map<String, String> dataset = new HashMap<String, String>();
        dataset.put("id", "6585");
        dataset.put("status", "Released");
    ...
    class MockDDXMLConverterService extends DDXMLConverterServiceImpl {

        Map<String, String> datasetResult = null;
        private DDXMLConverterService spreadsheetReader;

        public MockDDXMLConverterService(DDXMLConverterService spreadsheetReader, File inFile) throws ConversionException {
            super();
        ...
        @Override
        protected void importSheetSchemas(SourceReaderService spreadsheet, DD_XMLInstance instance, String xml_schema) {
